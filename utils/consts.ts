...
export const USER_SESSION_READ="usersession.read";
export const USER_SESSION_DELETE="usersession.delete";
export const TENANT_USER_ASSIGN="tenant.user.assign";
export const TENANT_USER_REMOVE="tenant.user.remove";
...
export const ALL_INTERNAL_SCOPE_NAMES = [
    ...
    USER_SESSION_READ, USER_SESSION_DELETE, TENANT_USER_ASSIGN, TENANT_USER_REMOVE,
