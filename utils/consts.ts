...
export const MFA_RESET_SCOPE="mfa.reset";
...
export const ALL_INTERNAL_SCOPE_NAMES_DISPLAY: Array<{scopeName: string, scopeDescription: string}> = [
    ...
    {scopeName: MFA_RESET_SCOPE, scopeDescription: "Reset MFA for user"},
...
export const ROOT_TENANT_EXCLUSIVE_INTERNAL_SCOPE_NAMES = [
    ...
    // Users
    USER_DELETE_SCOPE, USER_SESSION_READ_SCOPE, USER_SESSION_DELETE_SCOPE, TENANT_USER_ASSIGN_SCOPE, USER_UNLOCK_SCOPE, MFA_RESET_SCOPE,
    // External OIDC providers
...
export const DEFAULT_MAX_PASSWORD_RESET_ATTEMPTS=10;
...
export const CHANGE_EVENT_CLASS_CLIENT_FAPI_CONFIGURATION="CLIENT_FAPI_CONFIGURATION";
...
export const CHANGE_EVENT_CLASSES=[
    ...
    CHANGE_EVENT_CLASS_CLIENT_FAPI_CONFIGURATION,
