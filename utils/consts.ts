...
export const TWO_FACTOR_AUTH_TYPE_NONE="NONE";
export const TWO_FACTOR_AUTH_TYPE_SMS="SMS";
export const TWO_FACTOR_AUTH_TYPE_EMAIL="EMAIL";
export const TWO_FACTOR_AUTH_TYPE_TIME_BASED_OTP="TIME_BASED_OTP";
export const TWO_FACTOR_AUTH_TYPE_HARDWARE="HARDWARE";
export const TWO_FACTOR_AUTH_TYPES=[
    TWO_FACTOR_AUTH_TYPE_NONE,
    TWO_FACTOR_AUTH_TYPE_SMS,
    TWO_FACTOR_AUTH_TYPE_EMAIL,
    TWO_FACTOR_AUTH_TYPE_TIME_BASED_OTP,
    TWO_FACTOR_AUTH_TYPE_HARDWARE
];
...
export const CONTACT_TYPE_SIGNING_KEY="SIGNING_KEY_CONTACT"
