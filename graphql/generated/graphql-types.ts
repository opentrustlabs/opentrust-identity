...
export type Query = {
  ...
  getRateLimitTenantRels: Array<TenantRateLimitRelView>;
...
export type QueryResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getRateLimitTenantRels?: Resolver<Array<ResolversTypes['TenantRateLimitRelView']>, ParentType, ContextType, Partial<QueryGetRateLimitTenantRelsArgs>>;
