...
export type LoginAuthenticationHandlerResponse = {
  ...
  secondFactorType?: Maybe<Array<SecondFactorType>>;
...
export type Mutation = {
  ...
  createPortalLoginEmailHandlerResponse: PortalLoginEmailHandlerResponse;
  ...
  generateAuthorizationReturnUri?: Maybe<AuthorizationReturnUri>;
  ...
  verifyVerificationToken: Scalars['Boolean']['output'];
};
...
export type MutationCreatePortalLoginEmailHandlerResponseArgs = {
  email: Scalars['String']['input'];
...
export type MutationGenerateAuthorizationReturnUriArgs = {
...
export type MutationVerifyVerificationTokenArgs = {
...
export enum PortalLoginEmailHandlerErrorTypes {
  ConditionsForAuthenticationNotMet = 'CONDITIONS_FOR_AUTHENTICATION_NOT_MET',
  ExclusiveTenantAndNoFederatedOidcProvider = 'EXCLUSIVE_TENANT_AND_NO_FEDERATED_OIDC_PROVIDER',
  NoManagementDomain = 'NO_MANAGEMENT_DOMAIN',
  NoMatchingFederatedProviderForTenant = 'NO_MATCHING_FEDERATED_PROVIDER_FOR_TENANT',
  NoMatchingUserAndNoTenantSelfRegistration = 'NO_MATCHING_USER_AND_NO_TENANT_SELF_REGISTRATION'
}

export type PortalLoginEmailHandlerResponse = {
  __typename?: 'PortalLoginEmailHandlerResponse';
  authorizationEndpoint?: Maybe<Scalars['String']['output']>;
  errorType?: Maybe<PortalLoginEmailHandlerErrorTypes>;
  federatedOIDCProviderId?: Maybe<Scalars['String']['output']>;
  successNextStep?: Maybe<PortalLoginEmailHandlerSuccessNextStep>;
  tenantSelectors?: Maybe<Array<TenantSelectorData>>;
};

export enum PortalLoginEmailHandlerSuccessNextStep {
  AuthWithFederatedProvider = 'AUTH_WITH_FEDERATED_PROVIDER',
  Login = 'LOGIN',
  Register = 'REGISTER',
...
export type ResolversTypes = ResolversObject<{
  ...
  PasswordConfigInput: PasswordConfigInput;
  PortalLoginEmailHandlerErrorTypes: PortalLoginEmailHandlerErrorTypes;
  PortalLoginEmailHandlerResponse: ResolverTypeWrapper<PortalLoginEmailHandlerResponse>;
  PortalLoginEmailHandlerSuccessNextStep: PortalLoginEmailHandlerSuccessNextStep;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  PasswordConfigInput: PasswordConfigInput;
  PortalLoginEmailHandlerResponse: PortalLoginEmailHandlerResponse;
...
export type LoginAuthenticationHandlerResponseResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['LoginAuthenticationHandlerResponse'] = ResolversParentTypes['LoginAuthenticationHandlerResponse']> = ResolversObject<{
  ...
  secondFactorType?: Resolver<Maybe<Array<ResolversTypes['SecondFactorType']>>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  createPortalLoginEmailHandlerResponse?: Resolver<ResolversTypes['PortalLoginEmailHandlerResponse'], ParentType, ContextType, RequireFields<MutationCreatePortalLoginEmailHandlerResponseArgs, 'email'>>;
  ...
  generateAuthorizationReturnUri?: Resolver<Maybe<ResolversTypes['AuthorizationReturnUri']>, ParentType, ContextType, RequireFields<MutationGenerateAuthorizationReturnUriArgs, 'preAuthToken'>>;
  ...
  login?: Resolver<ResolversTypes['LoginAuthenticationHandlerResponse'], ParentType, ContextType, RequireFields<MutationLoginArgs, 'password' | 'tenantId' | 'username'>>;
  ...
  registerUser?: Resolver<ResolversTypes['RegisterUserResponse'], ParentType, ContextType, RequireFields<MutationRegisterUserArgs, 'tenantId' | 'userInput'>>;
  ...
  verifyVerificationToken?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationVerifyVerificationTokenArgs, 'token' | 'userId'>>;
}>;
...
export type PortalLoginEmailHandlerResponseResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['PortalLoginEmailHandlerResponse'] = ResolversParentTypes['PortalLoginEmailHandlerResponse']> = ResolversObject<{
  authorizationEndpoint?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  errorType?: Resolver<Maybe<ResolversTypes['PortalLoginEmailHandlerErrorTypes']>, ParentType, ContextType>;
  federatedOIDCProviderId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  successNextStep?: Resolver<Maybe<ResolversTypes['PortalLoginEmailHandlerSuccessNextStep']>, ParentType, ContextType>;
  tenantSelectors?: Resolver<Maybe<Array<ResolversTypes['TenantSelectorData']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type Resolvers<ContextType = OIDCContext> = ResolversObject<{
  ...
  PortalLoginEmailHandlerResponse?: PortalLoginEmailHandlerResponseResolvers<ContextType>;
