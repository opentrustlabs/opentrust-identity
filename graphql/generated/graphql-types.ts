...
export type Mutation = {
  ...
  addRecoveryEmail: UserRegistrationStateResponse;
...
export type MutationAddRecoveryEmailArgs = {
...
export type MutationResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  addRecoveryEmail?: Resolver<ResolversTypes['UserRegistrationStateResponse'], ParentType, ContextType, RequireFields<MutationAddRecoveryEmailArgs, 'recoveryEmail'>>;
  ...
  deleteRecoveryEmail?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, Partial<MutationDeleteRecoveryEmailArgs>>;
