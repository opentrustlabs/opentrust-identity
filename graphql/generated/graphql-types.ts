...
export type PortalUserProfile = {
  ...
  authenticationLevel?: Maybe<Scalars['String']['output']>;
  authenticationMethod?: Maybe<Array<Scalars['String']['output']>>;
...
export type PortalUserProfileResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['PortalUserProfile'] = ResolversParentTypes['PortalUserProfile']> = ResolversObject<{
  ...
  authenticationLevel?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  authenticationMethod?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
