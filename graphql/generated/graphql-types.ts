...
export type QueryGetRateLimitTenantRelViewsArgs = {
  rateLimitServiceGroupId: Scalars['String']['input'];
};
...
export type QueryResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getRateLimitTenantRelViews?: Resolver<Array<ResolversTypes['TenantRateLimitRelView']>, ParentType, ContextType, RequireFields<QueryGetRateLimitTenantRelViewsArgs, 'rateLimitServiceGroupId'>>;
