...
export type MutationResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  authenticateWithSocialOIDCProvider?: Resolver<ResolversTypes['UserAuthenticationStateResponse'], ParentType, ContextType, RequireFields<MutationAuthenticateWithSocialOidcProviderArgs, 'federatedOIDCProviderId' | 'preAuthToken'>>;
