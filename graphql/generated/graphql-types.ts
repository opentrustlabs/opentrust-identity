...
export enum AuthenticationState {
  ...
  Register = 'REGISTER',
  ReplacePassword = 'REPLACE_PASSWORD',
...
export type Mutation = {
  ...
  replacePassword?: Maybe<Scalars['Boolean']['output']>;
...
export type MutationReplacePasswordArgs = {
...
export type MutationResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  replacePassword?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType, RequireFields<MutationReplacePasswordArgs, 'newPassword' | 'oldPassword' | 'userId'>>;
