...
export type Query = {
  ...
  getDomainsForTenantAuthentication: Array<Scalars['String']['output']>;
...
export type QueryResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getDomainsForTenantAuthentication?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<QueryGetDomainsForTenantAuthenticationArgs, 'tenantId'>>;
