...
export type Mutation = {
  ...
  deleteClientFapiConfiguration: Scalars['String']['output'];
...
export type MutationResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  deleteClientFapiConfiguration?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<MutationDeleteClientFapiConfigurationArgs>>;
