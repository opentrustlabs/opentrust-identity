...
export type SystemSettings = {
  ...
  smsAlertOnRecoveryEmailChange: Scalars['Boolean']['output'];
  smsAllowPasswordResetForValidatedNumbers: Scalars['Boolean']['output'];
...
export type SystemSettingsUpdateInput = {
  ...
  smsAlertOnRecoveryEmailChange: Scalars['Boolean']['input'];
  smsAllowPasswordResetForValidatedNumbers: Scalars['Boolean']['input'];
...
export type SystemSettingsResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['SystemSettings'] = ResolversParentTypes['SystemSettings']> = ResolversObject<{
  ...
  smsAlertOnRecoveryEmailChange?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  smsAllowPasswordResetForValidatedNumbers?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
