...
export type MutationResolvers<ContextType = OIDCContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  registerAddBackupEmail?: Resolver<ResolversTypes['UserRegistrationStateResponse'], ParentType, ContextType, RequireFields<MutationRegisterAddBackupEmailArgs, 'backupEmail' | 'registrationSessionToken' | 'skip' | 'userId'>>;
