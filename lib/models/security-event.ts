...
export type SecurityEventType = "account_locked" | "duress_password_authentication" | "successful_authentication" | "reset_password" | "backup_email_authentication" | "logout";
