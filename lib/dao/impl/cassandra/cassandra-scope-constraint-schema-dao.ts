import ScopeConstraintSchemaDao from "../../scope-constraint-schema-dao";


class CassandraScopeConstraingSchemaDao extends ScopeConstraintSchemaDao {
...
export default CassandraScopeConstraingSchemaDao;