                        ...
                        (client: Client) => (
                            <Typography key={`${client.clientId}`} component={"div"} fontSize={"0.9em"}>
                                ...
                                <Grid2  margin={"8px 0px 8px 0px"} container size={12} spacing={1}>
                                    ...
                                    <Grid2 size={8}><Link style={{color: "", fontWeight: "bold", textDecoration: "underline" }} href={`tenants/${client.clientId}`}>{client.clientName}</Link></Grid2>
                                    <Grid2 size={2}>{client.enabled ? "true" : "false"}</Grid2>
                                    <Grid2 size={1}>
                        ...
                        (client: Client) => (
                            <Typography key={`${client.clientId}`} component={"div"} fontSize={"0.9em"}>
                                ...
                                <Grid2  margin={"8px 0px 8px 0px"} container size={12} spacing={1}>
                                    ...
                                    <Grid2 size={2.7}><Link style={{color: "", fontWeight: "bold", textDecoration: "underline" }} href={`${client.tenantId}/tenants/${client.tenantId}`}>{client.clientName}</Link></Grid2>
                                    <Grid2 size={3}>{client.clientDescription}</Grid2>
                                    <Grid2 size={2}>{CLIENT_TYPES_DISPLAY.get(client.clientType)}</Grid2>
                                    <Grid2 size={1}>{client.enabled ? "true" : "false"}</Grid2>
