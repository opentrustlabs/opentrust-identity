...
export interface ForgotPasswordOtpProps {
    token: string,
    name: string,
        ...
        <Html>
            ...
            <Body style={{fontFamily: "Arial, sans-serif", fontSize: "16px"}}>
                ...
                <Container style={{marginBottom: "24px"}}>
                    <Text>
                        {intl.formatMessage({id: "USE_THE_FOLLOWING_CODE_TO_RESET_YOUR_PASSWORD"})}
                    </Text>
                    <Text>
                        <pre>{token}</pre>
                    </Text>
                ...
                <Container style={{marginBottom: "24px"}}>                    
                    <Text>
                        {intl.formatMessage({id: "UNAUTHORIZED_PASSWORD_RESET"})}
                    </Text>
                ...
                {contactEmail &&
                    <Container style={{marginBottom: "24px"}}>
                        <Button
                            href={`mailto:${contactEmail}?subject=Unauthorized Password Reset Attempt`}
                            target="_blank"
                        ...
                        >
                            {intl.formatMessage({id: "REPORT_UNAUTHORIZED_PASSWORD_RESET"})}
                        </Button>
                    </Container>
                }
            </Body>
