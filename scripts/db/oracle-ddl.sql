...
create TABLE tenant_look_and_feel (
    tenantid VARCHAR2(64) PRIMARY KEY,
    headerbackgroundcolor VARCHAR2(32),
    headertextcolor VARCHAR2(32),    
    logouri VARCHAR2(256),
    headertext VARCHAR2(128),
    buttonbackgroundcolor VARCHAR2(32),
    buttontextcolor VARCHAR2(32),
    inputbordercolor VARCHAR2(32),
    pagebackgroundcolor VARCHAR2(32),
    footerbackgroundcolor VARCHAR2(32),
    footertextcolor VARCHAR2(32),
    linkcolor VARCHAR2(32),
    layouttype VARCHAR2(32),
    marketingimageuri VARCHAR2(256),
